...
class TestBackground(unittest.TestCase):
    ...
    def test_update(self):
        ...
        self.assertEqual(self.background.pos[0], initial_pos[0] + self.background.speed, "Update position test failed")
...
class TestBackgrounds(unittest.TestCase):
    ...
    def test_update(self):
        for background in self.backgrounds.background_images:
            ...
            background.update()
            self.assertEqual(background.pos[0], initial_pos[0] + background.speed, "Update position test failed")
