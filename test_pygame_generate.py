...
class TestGenerate(unittest.TestCase):
    ...
    def test_data_structure_time(self):
        ...
        self.assertLess(time_hash_table, time_bst, "Hash Table is not faster than BST")
        ...
        # Compare the time taken
        self.assertLess(time_hash_table, time_linked_list, "Hash Table is not faster than linked list")
        ...
        # Compare the time taken
        self.assertLess(time_hash_table, time_tries, "Hash Table is not faster than trie")
